          ...
          <div className="pt-6 border-t border-white/5 flex flex-wrap gap-4 items-center">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="w-10 h-10 rounded-full bg-[#1DA1F2]/20 hover:bg-[#1DA1F2]/40 border border-[#1DA1F2]/30 flex items-center justify-center transition-all"
              >
                <i className="fab fa-x-twitter text-[#1DA1F2]"></i>
              </button>
              <button
                onClick={() => handleShare('facebook')}
                className="w-10 h-10 rounded-full bg-[#4267B2]/20 hover:bg-[#4267B2]/40 border border-[#4267B2]/30 flex items-center justify-center transition-all"
              >
                <i className="fab fa-facebook-f text-[#4267B2]"></i>
              </button>
              <button
                onClick={() => handleShare('whatsapp')}
                className="w-10 h-10 rounded-full bg-[#25D366]/20 hover:bg-[#25D366]/40 border border-[#25D366]/30 flex items-center justify-center transition-all"
              >
